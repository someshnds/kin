            ...
            <div class="app-card-item col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="app-item app-{{ $plugin->path }}">
                    ...
                    <div class="app-footer">
                        ...
                        <div class="app-author">{{ trans('packages/plugin-management::plugin.author') }}: <!--<a href="{{ $plugin->url }}" target="_blank">{{ $plugin->author }}</a>--><span class="sm-tt">Somesh Bhatiya</span></div>
